...
from custom_trainer import PrefixTrainer
from utils import set_seed, set_logging, set_devices
from constant import MODEL_DIRS
...
def get_args():
    ...
    parser.add_argument('--data_dir', type=str, default='../custom_data_train_val')
    # probably create a new directory for our own data
    parser.add_argument('--output_dir', type=str, default='../custom_trained/')
